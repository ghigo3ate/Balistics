...
namespace Balistics
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for(int t = 1; t<Math.Abs(GetTime(v, angle)); t+=3)
            {
                Console.WriteLine("Time: " + t + "seconds. Current speed:" + (v + resistance*t) + "meteres per second. Current placement on axis:" + (V.x*t) + "metres.");
            }
        }
